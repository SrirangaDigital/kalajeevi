...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="html/css/custom.css?v=1.0">
...
<body>
  <nav id="mainNavBar" class="navbar navbar-light navbar-expand-lg fixed-top kannada">
    <div class="container-fluid clear-paddings">
      <p class="navbar-text" id="navbarText">ಡಾ || ‛ಜೀವಿ’ ಕುಲಕರ್ಣಿ</p>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav nav ml-auto">
          <li><a href="#001">ಮುಖಪುಟ</a></li>
          <li><a href="#002">ಕೃತಿಗಳು</a></li>
          <li><a href="html/award.php">ಪ್ರಶಸ್ತಿಗಳು</a></li>
